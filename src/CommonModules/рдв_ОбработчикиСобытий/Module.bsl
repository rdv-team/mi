...
Процедура СправочникиПриЗаписи(Источник, Отказ) Экспорт
	...
	Исключение
		ИмяСобытия = НСтр("ru = 'Регистрация изменений.Справочники при записи.'");
...
Процедура ДокументыПриЗаписи(Источник, Отказ) Экспорт
	...
	Исключение
		ИмяСобытия = НСтр("ru = 'Регистрация изменений.Документ при записи.'");
		ЗаписьЖурналаРегистрации(ИмяСобытия,
							УровеньЖурналаРегистрации.Ошибка,,, ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
	КонецПопытки;
...
Процедура НаборыЗаписейПриЗаписи(Источник, Отказ, Замещение) Экспорт
	...
	Исключение
		ИмяСобытия = НСтр("ru = 'Регистрация изменений.Наборы записей при записи.'");
		ЗаписьЖурналаРегистрации(ИмяСобытия,
							УровеньЖурналаРегистрации.Ошибка,,, ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
	КонецПопытки;
