...
Функция СтруктураСтандартногоЗапроса(ДанныеЗапроса, ДанныеМетода) Экспорт
	...
	МетаданныеСообщения.Вставить("direction", 	?(ДанныеЗапроса.ЭтоПодтверждениеПолучения, "reciever", "sender"));
	МетаданныеСообщения.Вставить("object_type", ДанныеЗапроса.ТипОбъекта);
