...
Функция РеквизитыФормыМодифицированы(Форма) Экспорт
	...
	// VELO-877 21.11.2023 astepanov@rdv-it.ru
	// Подвергалась ли уже форма модификации
	// Проверяем в ПриСоздании и ПриЧтенииНаСервере чтобы не создавать 2 раза реквизиты
