...
Процедура ЗаполнитьСписокОчередей(СписокОчередей) Экспорт
	...
	рдв_РаботаСОчередямиИнтеграции.ЗаполнитьСписокОчередей(СписокОчередей);
...
Процедура ЗаполнитьТипОчередиПоУмолчанию(ИмяОчереди, ТипОчередиОбъект) Экспорт
	...
	рдв_РаботаСОчередямиИнтеграции.ЗаполнитьТипОчередиПоУмолчанию(ИмяОчереди, ТипОчередиОбъект);
...
Процедура ВыполнитьОбработкуОчереди(ИмяОчереди, ИдентификаторыОчереди, РезультатОбработки) Экспорт
	...
	рдв_РаботаСОчередямиИнтеграции.ВыполнитьОбработкуОчереди(ИмяОчереди, ИдентификаторыОчереди, РезультатОбработки);
