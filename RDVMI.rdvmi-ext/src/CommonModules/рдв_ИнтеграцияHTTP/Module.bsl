...
Процедура ОтправитьСообщение(ПараметрыСоединения, Соединение, Сообщение, РезультатОтправки, ДополнительныеПараметры) Экспорт
	...
	АдресРесурса = АдресРесурса(АдресСервиса, Сообщение.АдресМетода);
...
Функция АдресРесурса(ВиртуальныйХост, АдресМетода)
	
	МассивПути = Новый Массив;
	МассивПути.Добавить("/");
	МассивПути.Добавить(ВиртуальныйХост);//БазовыйURL
