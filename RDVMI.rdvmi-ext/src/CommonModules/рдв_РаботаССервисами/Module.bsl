...
Функция ИнициализироватьДанныеСервиса(ПараметрыСервиса, Запрос = Неопределено, ИмяВидаСообщения = "", Знач Направление = Неопределено, ИдентификаторСообщения = Неопределено) Экспорт
	...
	Если ПараметрыСервиса.Свойство("ИдентификаторСобытия") Тогда
		ДанныеСервиса.ИдентификаторСобытия = ПараметрыСервиса.ИдентификаторСобытия;
	КонецЕсли;
...
Функция ЗаписатьСообщениеИнтеграции(ДанныеЗапроса, ДанныеОтвета = Неопределено, ДанныеСервиса) Экспорт
	...
	Интерфейс = ДанныеСервиса.Интерфейс;
	ВидСообщения = ДанныеСервиса.ВидСообщения;
	...
	Если ДанныеСервиса.Направление = Перечисления.рдв_НаправленияСообщенийИнтеграции.Входящее Тогда
		ЗаписыватьДанныеСообщений = Истина;
	Иначе
	...
	СообщениеОбъект.ИдентификаторСобытия = ДанныеЗапроса.ИдентификаторСобытия;
	СообщениеОбъект.ВнешняяСистема = ДанныеЗапроса.ВнешняяСистема;
...
Функция ВыполнитьЗапрос(ДанныеСервиса, АдресМетода, ТекстСообщения, ВнешняяСистема)
	...
	ДанныеЗапроса.ВнешняяСистема = ВнешняяСистема;
	ДанныеЗапроса.ИдентификаторСобытия = ДанныеСервиса.ИдентификаторСобытия;
...
Функция ВыгрузитьСообщение(ПараметрыСообщения) Экспорт	
 	...
 	ДанныеСервиса = рдв_РаботаССервисами.ИнициализироватьДанныеСервиса(ПараметрыСообщения, Неопределено);
...
Функция ПолучитьСтруктуруДанныхСервиса(ПараметрыСервиса)
	...
	ДанныеСервиса.Вставить("Направление");
	ДанныеСервиса.Вставить("ВидСообщения", ПараметрыСервиса.ВидСообщения);
	ДанныеСервиса.Вставить("Интерфейс", ПараметрыСервиса.Интерфейс);
	ДанныеСервиса.Вставить("СтандартнаяСтруктураЗапроса", ПараметрыСервиса.СтандартнаяСтруктураЗапроса);
	ДанныеСервиса.Вставить("ОбъектыСообщения", Новый Массив);
	ДанныеСервиса.Вставить("ИдентификаторСообщения");
	ДанныеСервиса.Вставить("ИдентификаторСобытия");
...
Функция ДанныеЗапроса(URI = Неопределено) Экспорт
	...
	ДанныеЗапроса.Вставить("ВнешняяСистема");
	...
	ДанныеЗапроса.Вставить("ИдентификаторСобытия", Строка(Новый УникальныйИдентификатор()));
...
Функция ДанныеОтвета() Экспорт
	...
	ДанныеОтвета.Вставить("Отменено", "");
