...
[Инструкция по установке](./doc/admin/how_to_install_mi.md)
...
Все необходимые для работы объекты в 1С располагаются в разделе "Интеграция (РДВ)":
   ...
   * Выполнить настройку подключений Справочника "ВнешниеСистемы"
     ...
     [Инструкция по установке](./doc/admin/how_to_1c.md)
...
###  3.7 <a name='getting_data'></a>Настроить Контроль целостности

[Инструкция по установке](./doc/4_check_that_data_fine.md)

# 4. <a name='full_dev_instruction'></a>Подробная инструкция разработчика

[Подробная инструкция](./doc/README.md)
